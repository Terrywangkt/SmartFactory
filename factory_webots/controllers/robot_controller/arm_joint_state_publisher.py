...
class ArmJointStatePublisher(object):
    ...
    def __init__(self, robot, jointPrefix, nodeName):
        ...
        for name in ArmJointStatePublisher.jointNames:
    ...
    def publish(self):
        ...
        msg.name = [s + self.jointPrefix for s in ArmJointStatePublisher.jointNames]
        msg.position = []
