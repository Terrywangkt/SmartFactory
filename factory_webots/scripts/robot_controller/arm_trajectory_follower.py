...
class ArmTrajectoryFollower(object):
    ...
    def __init__(self, robot, jointStatePublisher, jointPrefix, nodeName, goal_time_tolerance=None):
        ...
        self.prefixedJointNames = [s + self.jointPrefix for s in ArmTrajectoryFollower.jointNames]
        self.jointStatePublisher = jointStatePublisher
        self.timestep = int(robot.getBasicTimeStep())
        self.motors = []
        self.sensors = []
        for name in ArmTrajectoryFollower.jointNames:
        ...
        self.server = actionlib.ActionServer(nodeName + "/arm_group_controller/follow_joint_trajectory",
    ...
    def on_cancel(self, goal_handle):
        ...
        if goal_handle == self.goal_handle:
            # stop the motors
            for i in range(len(ArmTrajectoryFollower.jointNames)):
